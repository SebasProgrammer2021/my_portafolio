  ...
  return (
    <nav className="navbar dark:bg-neutral-900 lg:w-fit rounded-3xl">
      <ul className="navbarList flex flex-col gap-5 lg:gap-0 text-black items-center text-xl lg:flex-row lg:w-full lg:justify-center">
        {navigation.map((item) => (
          <li key={item.name} id="itemEnlace" className="navbarListItem flex items-center hover:bg-gray-300 dark:hover:text-black hover:rounded-3xl text-black dark:text-white font-semibold">
