    ...
    <section className="aboutMe" id="aboutMe">
      ...
      <div className="aboutMeContenteContainer">
        ...
        <p className="aboutMeProfileDescription">
          ...
          <a className="getCvLink" href="https://www.canva.com/design/DAFHqHRsvnc/2UxPP4G5oDsF1qzJt3L_MA/edit?utm_content=DAFHqHRsvnc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" target="_blank">Download cv</a>
        </p>
      </div>
    </section>
  )
